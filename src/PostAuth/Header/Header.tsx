...
function Header() {
  ...
  return (
    <div style={{width:'100%',boxSizing:'border-box',display:'flex',justifyContent:'space-around',alignItems:'center',height:"12%"}}>
                <div style={{width:width>850?'35%':'80%',margin:width>850?'':'0px auto',height:'45px',border:'2px solid #c7eaea',borderRadius:'10px',position:'relative',display:'flex',alignItems:'center'}}>
